...
class _sms_JAMApproval extends XocpBlock {
   ...
   function requestList() {
      ...
      $sql = "SELECT org_class_id FROM ".XOCP_PREFIX."orgs WHERE org_id = '$org_ids'";
      $result = $db->query($sql);
      ...
      $sql = "SELECT a.employee_id,a.employee_ext_id,"
       ...
       . " WHERE a.status_cd = 'normal' AND e.org_id = '$org_ids' AND f.org_class_id = '$current_org_class_id' AND c.gradeval > 5 AND b.person_id != $self_employee_id"
