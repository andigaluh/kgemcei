...
if ( !defined('antrainccmailreturn_DEFINED') ) {
   define('antrainccmailreturn_DEFINED', TRUE);

//include_once(XOCP_DOC_ROOT."/modules/hris/modconsts.php");
include_once(XOCP_DOC_ROOT."/modules/hris/include/vocab.php");

class _antrainccmailreturn extends XocpBlock {
   var $catchvar = _HRIS_CATCH_VAR;
   var $blockID = _antrainccmailreturn_BLOCK;
   var $width = "100%";
   var $language;
   var $display_title = TRUE;
   var $title = "Notification Cc Mail";
   ...
   function forminput() {
      ...
      /// include ajax file
      require_once(XOCP_DOC_ROOT."/modules/antrain/class/ajax_antrainccmailreturn.php");
      
      /// create ajax object
      $ajax_obj = new _antrainccmailreturnAjax("tx");
      ...
      require_once(XOCP_DOC_ROOT."/modules/antrain/class/ajax_antrainccmailreturn.php");
      $ajax = new _antrainccmailreturnAjax("empajx");
      $ex0 .= $ajax->getJs() . "
      ...
      /// the query
      $sql = "SELECT id,name,email,smtp_location FROM antrain_ccmail_return ORDER BY name";
