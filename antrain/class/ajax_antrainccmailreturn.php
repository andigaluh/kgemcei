...
if ( !defined('antrainccmailreturnAJAX_DEFINED') ) {
   define('antrainccmailreturnAJAX_DEFINED', TRUE);

require_once(XOCP_DOC_ROOT."/class/xocpajaxlistener.php");

class _antrainccmailreturnAjax extends AjaxListener {
   
   function __construct($act_name) {
      $this->_act_name = $act_name;
      $this->_include_file = XOCP_DOC_ROOT."/modules/antrain/class/ajax_antrainccmailreturn.php";
      $this->init();
      parent::init();
   }
   ...
   function app_deleteRecord($args) {
      ...
      $id = $args[0];
      $sql = "DELETE FROM antrain_ccmail_return WHERE id = '$id'";
      $db->query($sql);
   
      $sql = "SELECT id,name,email,smtp_location FROM antrain_ccmail_return ORDER BY name"; /// the query
   ...
   function editor($id,$prefix) {
      ...
      $sql = "SELECT name,email,smtp_location FROM antrain_ccmail_return WHERE id = '$id'";
      $result = $db->query($sql);
    ...
    function app_saveRecord($args) {
      ...
      $sql = "UPDATE antrain_ccmail_return SET "
           . "name = '$name',"
           . "email = '$email',"
   ...
   function app_addRecord($args) {
      ...
      $sql = "INSERT INTO antrain_ccmail_return(name,email,smtp_location) VALUES ('$name','$email','$smtp_location')";
      $db->query($sql);
