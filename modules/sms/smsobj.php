...
class _sms_SMSObj extends XocpBlock {
   ...
   $idobj = $_GET['idobj']; 
	...
	list($idobj,$id_themes,$id_ref_perspektive,$objective_code,$id_objective_owner,$id_objective_owner_2,$obj_title,$obj_desc)=$db->fetchRow($resultobj);
	 ...
	 // Add by denimaru
	$ret = "<div style='margin-bottom: 30px;padding-top: 1px;width: 870px;'><span style='float:right;'><input onclick='delete_obj(\"$idobj\",this,event)' type='button' value='Delete Objective' /></span></div>";
	// End of Add by denimaru
