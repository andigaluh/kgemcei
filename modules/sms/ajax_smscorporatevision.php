<?php
//--------------------------------------------------------------------//
// Filename : modules/antrain/class/ajax_smscorporatevision.php       //
...
class _sms_class_SMSCorporatevisionAjax extends AjaxListener {
   
   function __construct($act_name) {
      $this->_act_name = $act_name;
      $this->_include_file = XOCP_DOC_ROOT."/modules/sms/class/ajax_smscorporatevision.php";
      $this->init();
      parent::init();
   }
