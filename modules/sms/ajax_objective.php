...
class _sms_class_ObjectiveAjax extends AjaxListener {
  ...
  function app_savePropose($args) {
    ...
    $date_propose = getSQLDate();
        //$sql = "UPDATE sms_session SET section_submit_id = '$employee_id', section_submit_date = '$date_propose', section_submit = '$is_propose' WHERE id = '1'";
    ...
    return array($psid,$employee_id,$employee_nm,$date_propose);
   }
   ...
   function app_saveApproval($args) {
    ...
    $sql = "SELECT section_submit FROM sms_approval WHERE id_section_session = '$psid' AND org_id = '$org_id'";
    $db->query($sql);
    list($section_submit)=$db->fetchRow($sql);
    ...
    if ($section_submit == 1) {
      ...
      $sql = "INSERT INTO sms_approval (id_section_session,org_id,section_approval,section_approval_id,section_approval_date)VALUES ('$psid','$org_id','$is_approve','$employee_id','$date_approve')";
    }
        $db->query($sql);
...
/*  $sql = "SELECT year,budget,remark,date_created"
  ...
  function app_saveReturn($args) {
    ...
    $sqlto = "SELECT p.user_id,ps.email,ps.person_nm,pk.section_submit_date FROM hris_users p LEFT JOIN hris_persons ps ON p.person_id = ps.person_id LEFT JOIN sms_approval pk ON p.user_id = pk.section_submit_id WHERE pk.id_section_session = $psid";
    ...
    $subject =  "Revision $namato";
           ...
           //$recipient = $to;
           $recipient = "fahmi@komunitest.com";
           //$headers["From"]    = "hris@mcci.com";
           $headers["From"]    = "deni@komunitest.com";
           //$headers["To"]      = $emailto;
           $headers["To"]      = "fahmi@komunitest.com";
       ...
       //$headers["Cc"] =  $emailcc;
           ...
           $body =  "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'>
                    ...
                    <p>
                     ...
                     <br/>
                     <br/>
                    I have been return your SMS Section Objective year $year please check again.
                     <br/>
                    Thank You
                    <br/>
                    $namafrom
           ...
           //return array($str);
            ...
            $sql = "UPDATE sms_approval SET "
                 . "section_submit = '0', remark = '$remark'"         
