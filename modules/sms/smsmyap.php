...
if ( !defined('SMS_MYAP_DEFINED') ) {
   define('SMS_MYAP_DEFINED', TRUE);
...
class _sms_MyactionPlan extends XocpBlock {
   var $catchvar = _SMS_CATCH_VAR;
   var $blockID = _SMS_MYACTIONPLAN_BLOCK;
   var $width = "100%";
   var $language;
   var $display_title = TRUE;
   var $title = _SMS_MYACTIONPLAN_BLOCK_TITLE;
   var $display_comment = TRUE;
   var $data;
   
   function _sms_MyActionPlan($catch=NULL) { /* fungsi konstruktor wajib punya parameter $catch
   ...
   function myactionplan($employee_id,$report_mode=FALSE,$force_month_id=0) {
      ...
      list($session_nm)=$db->fetchRow($result);
		...
		$sqlyear = "SELECT id,periode_session,title_session"
           . " FROM sms_session WHERE id = '$psid'";
	   $resultyear = $db->query($sqlyear);
       list($psid,$year,$title_session) = $db->fetchRow($resultyear);	 
     $ret = "<style type='text/css'>
				a.applelink {text-decoration:none; color: #08c;}
				a.applelink:hover {color: #08c; text-decoration: underline;}
				
				span.applelink {text-decoration:none; color: #08c;}
				span.applelink:hover {color: #08c; text-decoration: underline;}
				</style>";
	...
	$ret .= "<thead>"
				. "<tr>"
					...
					. "<td colspan='12' style='border-right:1px solid #bbb;text-align:center;'>$year</td>"
					. "<td style='text-align:center;border-right:0px solid #bbb;' rowspan='2'>Monthly Target</td>"
				. "</tr>"
				. "<tr>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=1' class='applelink' >Jan</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=2' class='applelink'>Feb</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=3' class='applelink'>Mar</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=4' class='applelink'>Apr</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=5' class='applelink'>May</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=6' class='applelink'>Jun</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=7' class='applelink'>Jul</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=8' class='applelink'>Aug</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=9' class='applelink'>Sep</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=10' class='applelink'>Oct</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=11' class='applelink'>Nov</a></td>"
					. "<td style='border-right:1px solid #bbb;text-align:center;'><a href='".XOCP_SERVER_SUBDIR."/index.php?employee_id=$employee_id&goto=y&month_id=12' class='applelink'>Dec</a></td>"
				. "</tr>"
	...
	$ret .= "<tbody>"
					. "<tr><td colspan='16'>Strategic</td></tr></tbody>"	;
	...
	if($db->getRowsNum($resultobj)>0) {
		...
		$ret .= "<tbody>"
					...
					. "<tr>"
						. "<td rowspan='$numrow' style='text-align:center; border-right: 1px solid #cccccc!important; '>$objective_code</td>";
					$ret .= "<tr><td  colspan='15' style='text-align:left;'><b>$objective_title</b></td></tr>";
	while(list($id_ksf,$ksf_code,$ksf_title,$ksf_lowper,$ksf_needimp,$ksf_target,$ksf_req,$ksf_far_req)=$db->fetchRow($resultksf)){
				
				$num++;
				$ret .= "<tr><td  colspan='15' style='text-align:left; font-size: 10px;'> &nbsp &nbsp $num. $ksf_title</td></tr>";
	...
	$sqlksfin = "SELECT a.id,a.ksf_code,a.ksf_title,a.ksf_lower_perform,a.ksf_need_improvement,a.ksf_target,a.ksf_req,a.ksf_far_req  FROM sms_objective_ksf a JOIN sms_objective_team b ON(a.id =  b.id_objective_ksf) WHERE b.id_pic = $person_id AND a.id_objective = $objid";
		...
		while(list($id_ksf,$ksf_code,$ksf_title,$ksf_lowper,$ksf_needimp,$ksf_target,$ksf_req,$ksf_far_req)=$db->fetchRow($resultksfin)){
			...
			$ret .= "<tr><td>KSF: </td><td  colspan='15' style='text-align:left;' id='tdaptext_new}' ><b>$ksf_title (<span class='xlnk applelink' onclick='add_actionplan(\"new\",\"$person_id\",\"$id_ksf\",\"$objid\",this,event);' id='spap_${id_ksf}_new'>Add Action Plan</span>)</b></td></tr>";
		
		
		//PIC Action Plan
				$sqlap = "SELECT  id,sms_objective_id,employee_id,actionplan_id,month_id,actionplan_text,target_text,final_result_text,current_achievement,current_kpi_achievement,target_achievement,final_achievement,final_kpi_achievement  FROM sms_pic_action WHERE psid = '$psid' AND employee_id = '$person_id' AND sms_objective_id = '$objid' AND actionplan_id  = '$id_ksf' GROUP BY actionplan_text";
				$resultap = $db->query($sqlap);
				while(list($idap,$sms_objective_id,$employee_id,$actionplan_id,$month_id,$actionplan_text,$target_text,$final_result_text,$current_achievement,$current_kpi_achievement,$target_achievement,$final_achievement,$final_kpi_achievement)=$db->fetchRow($resultap)){
					$no++;
			   ...
			   $ret .= "<tr><td colspan='3' id='tdaptext_${idap}' style='border-right:1px solid #bbb;vertical-align:top;overflow:hidden;padding:0px;'>";


				// $ret .= "<div onmousemove='show_ap_tooltip(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' onmouseover='mouseover_aptext(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' onmouseout='mouseout_aptext(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' class='aptext' id='dvap_${idap}_${actionplan_id}'>";
				// $ret .= "<span class='xlnk' onclick='edit_actionplan(\"$idap\",\"$actionplan_id\",this,event);' id='spap_${idap}_${actionplan_id}'>$actionplan_text</span>";	
				
				$ret .= "<div onmousemove='show_ap_tooltip(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' onmouseover='mouseover_aptext(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' onmouseout='mouseout_aptext(\"$no\",\"$idap\",\"$actionplan_id\",this,event);' class='aptext' id='dvap_${idap}_${actionplan_id}'>";
				$ret .= "<span class='xlnk applelink' onclick='edit_actionplan(\"$idap\",\"$actionplan_id\",\"$sms_objective_id\",this,event);' id='spap_${idap}_${actionplan_id}'>$actionplan_text</span>";
				
				 $ret .= "</div>";
				
				 
				/*  $tooltip .= "\n<div style='display:none;' id='intooltip_${idap}_${actionplan_id}'>"
						   . "<div>"
						   . "<table class='aptooltip'><tbody>"
				
						   . "<tr><td>SO : </td><td>$objective_title</td></tr>"
				...
				//MONTHS
					  for($i=1;$i<=12;$i++) {
						$sqlmnt = "SELECT month_id,current_achievement,report_approval_st FROM sms_pic_action WHERE psid = '$psid' AND employee_id = '$person_id' AND sms_objective_id = '$objid' AND actionplan_id  = '$id_ksf' AND month_id = '$i' AND id ='$idap' ";
						$resultmnt = $db->query($sqlmnt);
						list($month_id,$current_achievement,$report_approval_st)=$db->fetchRow($resultmnt);
						if($month_id==$i ){
						...
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:top;border-bottom:0; '>"
										. "	<div onmousemove='show_ap_tooltip(&quot;1574&quot;,&quot;15&quot;,this,event);' onmouseover='mouseover_aptext(&quot;0&quot;,&quot;1574&quot;,&quot;15&quot;,this,event);' onmouseout='mouseout_aptext(&quot;0&quot;,&quot;1574&quot;,&quot;15&quot;,this,event);' class='$xclass' style='background-color: transparent;'>"
											. "<div style='text-align:center;color:black;'>&nbsp;<img src='/hris_sms_test/images/spacer.gif'>"
							...
							{
								$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:top;border-bottom:0;'>"
										. "	<div onmousemove='show_ap_tooltip(&quot;1574&quot;,&quot;15&quot;,this,event);' onmouseover='mouseover_aptext(&quot;0&quot;,&quot;1574&quot;,&quot;15&quot;,this,event);' onmouseout='mouseout_aptext(&quot;0&quot;,&quot;1574&quot;,&quot;15&quot;,this,event);'  style='background-color: transparent;'>"
						...
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:top;border-bottom:0; colspan='2''>$target_text</td>";
				...
				$sqljam = "SELECT id,value FROM sms_jam_strategic WHERE person_id = $person_id AND id_objective = $objid AND id_session = '$psid'";
			...
			$ret .= "<tr>"
						. "<td colspan='3' style='border-right:1px solid #bbb;text-align:right;'>".toMoney($objective_weight)." %</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						...
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #bbb;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:0px solid #bbb;text-align:center;'>&nbsp;</td>"
					. "</tr>";
	...
	//FUNCTIONAL///////////////////////				
	$ret .= "<tr><td colspan='16'>Functional</td></tr>";
	...
	while(list($objid,$objective_title,$objective_weight)=$db->fetchRow($resultobj)){
    	$nm = $nom++;
				...
				$numrowap = $db->getRowsNum($resultactionplan)+2;	
				$ret .= " <tr>"
						. "<td rowspan='$numrowap' style='text-align:center; border-right: 1px solid #cccccc!important; '></td>";
				$ret .= "<tr><td  colspan='15' style='text-align:left;'><b>$objective_title</b></td></tr>";
				...
				$nums = 0;			
					while(list($objids,$sms_kpi_id,$sms_kpi_text)=$db->fetchRow($resultactionplan)){
							$nums++;
							$ret .= "<tr><td  colspan='15' style='text-align:left; font-size: 10px;'> &nbsp &nbsp $nums.  $sms_kpi_text</td></tr>";
							
							}
		//ACTION PLAN ADD Functional
			$sqlkpi =  "SELECT sms_objective_id,sms_kpi_id,sms_kpi_text FROM sms_kpi WHERE sms_objective_id='$objid'";
			$resultkpi = $db->query($sqlkpi);
			$numrow = $db->getRowsNum($resultkpi)+2;		
			$no = 0;
	
			while(list($objids,$sms_kpi_id,$sms_kpi_text)=$db->fetchRow($resultkpi)){
				
					$ret .= "<tr><td>KPI: </td><td  colspan='15' style='text-align:left;' id='tdaptext_new}' ><b>$sms_kpi_text</b></td></tr>";
					
					
					//PIC Action Plan Functional
					$sqlksfinfun = "SELECT  sms_action_plan_id,sms_action_plan_text,sms_kpi_id FROM sms_action_plan WHERE sms_action_plan_pic_employee_id LIKE '%$person_id%' AND sms_objective_id = $objids AND sms_kpi_id = '$sms_kpi_id'  ORDER BY sms_kpi_id";
					$resultksfinfun = $db->query($sqlksfinfun);
					$numrowfun = $db->getRowsNum($resultksfinfun)+2;		
					$no = 0;
			
					while(list($id_ap,$ap_title,$kpid)=$db->fetchRow($resultksfinfun)){
					
							$ret .= "<tr><td colspan='3' id='tdaptext_${id_ap}' style='border-right:1px solid #bbb;vertical-align:top;overflow:hidden;padding:0px;'>";
								$ret .= "<div onmousemove='show_ap_tooltip(\"$no\",\"$id_ap\",\"$kpid\",this,event);' onmouseover='mouseover_aptext(\"$no\",\"$id_ap\",\"$kpid\",this,event);' onmouseout='mouseout_aptext(\"$no\",\"$id_ap\",\"$kpid\",this,event);' class='aptext' id='dvap_${id_ap}_${kpid}'>";
									$ret .= "<span class='xlnk applelink' onclick='edit_actionplan_functional(\"$id_ap\",\"$kpid\",\"$objids\",this,event);' id='spap_${id_ap}_${kpid}'>$ap_title</span>";
								$ret .= "</div></span>" 
								   
											."</td>";
					//MONTHS
					  for($i=1;$i<=12;$i++) {
						$sqlmnt = "SELECT month_id,current_achievement,report_approval_st FROM sms_pic_action_functional WHERE psid = '$psid' AND employee_id = '$person_id' AND sms_objective_id = '$objid' AND actionplan_id  = '$kpid' AND month_id = '$i' AND id ='$id_ap' ";
						$resultmnt = $db->query($sqlmnt);
						list($month_id,$current_achievement,$report_approval_st)=$db->fetchRow($resultmnt);
						if($month_id==$i ){
						...
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:top;border-bottom:0; colspan='2''>$target_text</td></tr>";
				...
				$objective_weight_funtion = 0;
				$ret .= "<tr>"
						. "<td colspan='3' style='border-right:1px solid #bbb;text-align:right;'>".toMoney($objective_weight_function)." %</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
						. "<td style='border-right:1px solid #ddd;text-align:center;'>&nbsp;</td>"
	...
	$sqlsumjam = "SELECT SUM(value) FROM sms_jam_strategic WHERE person_id = '$person_id' AND id_session = '$psid' ";
					$resultsumjam = $db->query($sqlsumjam);
					list($sumobjective_weight)=$db->fetchRow($resultsumjam);

	$ret .= "<tr>"
					. "<td style='border-top:1px solid #bbb;background-color:#eee;color:black;border-right:1px solid transparent;text-align:center;font-weight:bold;' colspan='2'>Total</td>"
					. "<td style='border-top:1px solid #bbb;background-color:#eee;color:black;border-right:1px solid #bbb;text-align:right;font-weight:bold;'>$sumobjective_weight %</td>"
					. "<td style='border-top:1px solid #bbb;background-color:#eee;color:black;border-right:1px solid #bbb;text-align:right;font-weight:bold;' colspan='12'></td>"
					. "<td style='border-top:1px solid #bbb;background-color:#eee;color:black;border-right:0px solid #bbb;text-align:center;font-weight:bold;'>-</td>"
				. "</tr>"
...
/* 	$form = "<div style='width:900px;text-align:right;padding:10px;margin-top:10px;margin-bottom:100px;'>"
      ...
      var persedit = null;
      var persbox = null;
	  function add_actionplan(idap,person_id,actionplan_id,sms_objective_id,d,e) {
         persedit = _dce('div');
         ...
         persbox.init('persedit','550px','350px','hidden','default',false,false);
         persbox.lbo(false,0.3);
         persbox.appear();
        
         orgjx_app_addnewap(idap,person_id,actionplan_id,sms_objective_id,function(_data) {
	  ...
	  //SAVE NEW AP
	      function save_newap() {
         var ret = _parseForm('frmap');
         orgjx_app_saveNewAction(ret,function(_data) {
	  ...
	  //SAVE EDIT AP STRATEGIC
         ...
         orgjx_app_saveActionPlan(ret,function(_data) {
	  	  ...
	  	  //SAVE EDIT AP FUNCTIONAL
	  
	      function save_actionplan_functional() {
	  
         var choose_month = _parseForm('choose_month');
		 var ret = _parseForm('frmaps');
         orgjx_app_saveActionPlan_functional(ret,function(_data) {
              var data = recjsarray(_data);
			//alert(data);
            });
			 window.setTimeout(function(){location.reload()},2000)
      ...
      var dvtooltip = null;
      function show_ap_tooltip(no,idap,actionplan_id,d,e) {
         ...
         var xtooltip = $('intooltip_'+idap+'_'+actionplan_id);
         if(xtooltip) {
      ...
      function hide_ap_tooltip(no,idap,actionplan_id,d,e) {
         dvtooltip.style.left = '-1000px';
         dvtooltip.style.top = '-1000px';
         dvtooltip.style.visibility = 'hidden';
      }
      
      function mouseover_aptextpica(no,idap,actionplan_id,d,e) {
         //show_ap_tooltip(idap,actionplan_id,d,e);
         for(var i=1;i<=12;i++) {
            var td = $('tdap_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
               td.childNodes[no].style.backgroundColor = '#fcc';
            }
            td = $('tdpica_root_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
               td.childNodes[no].style.backgroundColor = '#fcc';
            }
            td = $('tdpica_improve_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
               td.childNodes[no].style.backgroundColor = '#fcc';
            }
            td = $('tdpica_month_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
               td.childNodes[no].style.backgroundColor = '#fcc';
            }
         }
         ...
         var tdap = $('tdaptext_'+idap);
         if(tdap&&tdap.childNodes&&tdap.childNodes[no]) {
            tdap.childNodes[no].style.backgroundColor = '#fcc';
         }
      }
      
      function mouseout_aptextpica(no,idap,actionplan_id,d,e) {
         if(dvtooltip) {
            hide_ap_tooltip(idap,actionplan_id,d,e);
         }
         
         if(dvapeditor&&dvapeditor.style.visibility=='visible') {
            if(dvapeditor.no==no&&dvapeditor.idap==idap) return;
         }
         for(var i=1;i<=12;i++) {
            var td = $('tdap_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
      ...
      function mouseover_aptext(no,idap,actionplan_id,d,e) {
      ...
      function mouseout_aptext(no,idap,actionplan_id,d,e) {
         if(dvtooltip) {
            hide_ap_tooltip(idap,actionplan_id,d,e);
         }
	 ...
	 //DELETE ACTION PLAN FUNCTIONAL
      function delete_actionplan_functional(idap,psid,person_id,actionplan_id,sms_objective_id,d,e) {
         orgjx_app_deleteActionPlan_functional(idap,psid,person_id,actionplan_id,sms_objective_id,function(_data) {
			 var data = recjsarray(_data);
			//alert(data);
         });
			window.setTimeout(function(){location.reload()},2000)
    ...
    //EDIT ACTION PLAN OBJECTIVE  
      var dvapeditor = null;
      function edit_actionplan(idap,actionplan_id,sms_objective_id,d,e) {
         if(dvtooltip) {
            hide_ap_tooltip(idap,actionplan_id,d,e);
         }
         var no = 0;
         ...
         for(var i=0;i<$('tdaptext_'+idap).childNodes.length;i++) {
            if($('tdaptext_'+idap).childNodes[i].id=='dvap_'+idap+'_'+actionplan_id) {
               no=i;
            }
         }
         
         dvapeditor.inner.innerHTML = '';
         dvapeditor.idap = idap;
         ...
         /// expose border
         $('dvap_'+idap+'_'+actionplan_id).style.borderTop = '1px solid #888';
         $('dvap_'+idap+'_'+actionplan_id).style.borderBottom = '1px solid #888';
         for(var i=1;i<=12;i++) {
            var td = $('tdap_'+idap+'_'+i);
            if(td&&td.childNodes&&td.childNodes[no]) {
         ...
         orgjx_app_editActionPlan(idap,'$person_id',actionplan_id,sms_objective_id,function(_data) {
            dvapeditor.inner.innerHTML = _data;
            setTimeout('$(\"inp_aptext\").focus();',100);
         });
      }
	  
	  //EDIT ACTION PLAN FUNCTIONAL
	        var dvapeditor = null;
      function edit_actionplan_functional(idap,actionplan_id,sms_objective_id,d,e) {
         if(dvtooltip) {
            hide_ap_tooltip(idap,actionplan_id,d,e);
         }
         var no = 0;
         ...
         orgjx_app_editActionPlanFunctional(idap,'$person_id',actionplan_id,sms_objective_id,function(_data) {
            dvapeditor.inner.innerHTML = _data;
            setTimeout('$(\"inp_aptext\").focus();',100);
         });
      }
     ...
     function report($employee_id,$force_month_id) {
      ...
      $ret = "<div style='max-width:900px;'><div style='border:1px solid #bbb;background-color:#eee;padding:5px;text-align:right;'>[<a href='".XOCP_SERVER_SUBDIR."/index.php'>Back to Action Plan</a>]</div></div>";
	...
	while(list($objid,$objective_title,$objective_weight)=$db->fetchRow($resultobj)){
		...
		while(list($objids,$sms_kpi_id,$sms_kpi_text)=$db->fetchRow($resultactionplan)){
			...
			//PIC Action Plan
			$sqlap = "SELECT  id,sms_objective_id,employee_id,actionplan_id,actionplan_text,target_text,final_result_text,current_achievement,current_kpi_achievement,target_achievement,final_achievement,final_kpi_achievement  FROM sms_pic_action_functional WHERE psid = '$psid' AND employee_id = '$person_id' AND sms_objective_id = '$objids' AND actionplan_id  = '$sms_kpi_id' AND month_id = '$month_id' GROUP BY actionplan_text";
			$resultap = $db->query($sqlap);
			...
			while(list($idap,$sms_objective_id,$employee_id,$actionplan_id,$actionplan_text,$target_text,$final_result_text,$current_achievement,$current_kpi_achievement,$target_achievement,$final_achievement,$final_kpi_achievement)=$db->fetchRow($resultap)){
				...
				$sqlaps = "SELECT  id,sms_objective_id,employee_id,actionplan_id,month_id,actionplan_text,notes,attachment,target_text,final_result_text,current_achievement,current_kpi_achievement,target_achievement,final_achievement,final_kpi_achievement  FROM sms_pic_action_functional WHERE psid = '$psid' AND employee_id = '$person_id' AND sms_objective_id = '$objids' AND actionplan_id  = '$sms_kpi_id' AND id = '$idap' AND month_id = '$month_id' GROUP BY actionplan_text";
					...
					$ret .= "<tr><td colspan='1' id='tdaptext_${idap}' style='border-right:1px solid #bbb;vertical-align:top;overflow:hidden;padding:0px;'>";
						...
						$ret .= "<span> - $actionplan_text</span>";
						$ret .= "</div></td>";
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:middle; text-align: center;'><span class='xlnk' onclick='edit_target_text(\"$idap\",\"$psid\",\"$person_id\",\"$objids\",\"$sms_kpi_id\",\"$month_id\",6,this,event);' style='text-decoration:none;' '>".toMoney($current_achievement)."  </span> %</td>";
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:middle; text-align: center;'><span class='xlnk' onclick='edit_target_text(\"$idap\",\"$psid\",\"$person_id\",\"$objids\",\"$sms_kpi_id\",\"$month_id\",7,this,event);' style='text-decoration:none;' '>$target_achievement</span></td>";
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:middle; text-align: center;'><span class='xlnk' onclick='edit_target_text(\"$idap\",\"$psid\",\"$person_id\",\"$objids\",\"$sms_kpi_id\",\"$month_id\",8,this,event);' style='text-decoration:none;' '>$target_text</span></td>";
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:middle; text-align: center;'><span class='xlnk' onclick='edit_target_text(\"$idap\",\"$psid\",\"$person_id\",\"$objids\",\"$sms_kpi_id\",\"$month_id\",9,this,event);' style='text-decoration:none;' '>$notes</span></td>";
						
						if($attachment==''){$downloadlink='';}else{$downloadlink="<a href='http://".$_SERVER['HTTP_HOST']."".XOCP_SERVER_SUBDIR."/modules/sms/upload/$attachment' target='_blank'>View Attachment</a>";}
						
						$ret .= "<td style='padding:0px;border-right:1px solid #ddd;vertical-align:middle; text-align: center;'><form action='http://".$_SERVER['HTTP_HOST']."".XOCP_SERVER_SUBDIR."/modules/sms/uploadfilesmsfunctional.php?idap=$idap&psid=$psid&employee_id=$person_id&sms_objective_id=$objids&sms_kpi_id=$sms_kpi_id&month_id=$month_id' method='post' enctype='multipart/form-data'><input type='button' value='Upload File' onclick='uplfile_functional($idap,$psid,$person_id,$objids,$sms_kpi_id,$month_id);'/>
							</form>$downloadlink</td>";
					$ret .= "</tr>";
    ...
    //SUBMIT
	 ...
	 #SUBMIT
		  $sqlsubmit = "SELECT report_approval_st,report_submit_dttm,report_approval_dttm FROM sms_pic_action WHERE psid = '$psid' AND employee_id = '$person_id' AND month_id = '$month_id' " ;
		  $resultsubmit = $db->query($sqlsubmit);
		  list($stat,$submit_date,$approve_date)=$db->fetchRow($resultsubmit);
	...
	$form = "<div style='width:900px;text-align:right;padding:10px;margin-top:10px;margin-bottom:100px;'>"
					. "<table align='center' style='border-top:2px solid #777;border-left:2px solid #777;border-spacing:0px;'>"
						...
						. "<tr>"
							...
							. "<td style='text-align:center;border-bottom:2px solid #777;border-right:2px solid #777;padding:10px;'> <br/> $approve_date</td>"
						. "</tr>"
					."</tbody>"
				."</table>"
			. "</div>";
      ...
      switch ($this->catch) {
         case $this->blockID:
            if($_GET["goto"]=="y") {
               ...
               $ret = $this->myactionplan($self_employee_id);
            }
            break;
         default:
            if($_GET["goto"]=="y") {
