...
if ( !defined('PMS_JAMORGACCESS_DEFINED') ) {
   define('PMS_JAMORGACCESS_DEFINED', TRUE);

include_once(XOCP_DOC_ROOT."/modules/hris/modconsts.php");
include_once(XOCP_DOC_ROOT."/modules/hris/include/vocab.php");

include_once(XOCP_DOC_ROOT."/modules/pms/class/ajax_jamorgaccess.php");
include_once(XOCP_DOC_ROOT."/modules/pms/class/selectpms.php");

class _pms_JAMOrgAccess extends XocpBlock {
   var $catchvar = _PMS_CATCH_VAR;
   var $blockID = _PMS_JAMORGACCESS_BLOCK;
   var $width = "100%";
   var $language;
   var $display_title = TRUE;
   var $title = _PMS_JAMORGACCESS_BLOCK_TITLE;
   ...
   function pmsorgaccess() {
      ...
      $ajax = new _hris_class_JAMOrgAccessAjax("fma");
...
class TreeOrg {
   ...
   function renderNodeOrg($node_id,$depth=0) {
      ...
      $emp = "<span style='white-space:normal;' id='spacc_${node_id}'>"._hris_class_JAMOrgAccessAjax::renderAccess($node_id)."</span>";
