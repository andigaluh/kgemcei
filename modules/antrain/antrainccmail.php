...
if ( !defined('ANTRAINCCMAIL_DEFINED') ) {
   define('ANTRAINCCMAIL_DEFINED', TRUE);

//include_once(XOCP_DOC_ROOT."/modules/hris/modconsts.php");
include_once(XOCP_DOC_ROOT."/modules/hris/include/vocab.php");

class _antrainccmail extends XocpBlock {
   ...
   function forminput() {
      ...
      /// include ajax file
      require_once(XOCP_DOC_ROOT."/modules/antrain/class/ajax_antrainccmail.php");
      
      /// create ajax object
      $ajax_obj = new _antrainccmailAjax("tx");
      ...
      require_once(XOCP_DOC_ROOT."/modules/antrain/class/ajax_antrainccmail.php");
      $ajax = new _antrainccmailAjax("empajx");
      $ex0 .= $ajax->getJs() . "
      ...
      /// the query
      $sql = "SELECT id,name,email,smtp_location FROM antrain_cc_email ORDER BY name";
