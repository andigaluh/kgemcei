...
class _antrain_sscancelalter extends XocpBlock {
   var $catchvar = _ANTRAIN_CATCH_VAR;
   var $blockID = _ANTRAIN_SSCANCELALTER_BLOCK;
   var $width = "100%";
   var $language;
   ...
   function _antrain_sscancelalter($catch=NULL) { /* fungsi konstruktor wajib punya parameter $catch
...
//INFORM
	if ( $job_class_id == 3 || $job_id == 999|| $job_id == 141|| $job_id == 68|| $job_id == 138|| $job_id == 132|| $job_id == 151|| $job_id == 37|| $job_id == 169|| $job_id == 107|| $job_id == 111|| $job_id == 74|| $job_id == 85|| $job_id == 49|| $job_id == 60|| $job_id == 91|| $job_id == 183|| $job_id == 25|| $job_id == 211|| $job_id == 220 ) {
	 ...
	 //Return to SM
	 if( $job_class_id == 2 || $job_id == 999|| $job_id == 6|| $job_id == 36|| $job_id == 48|| $job_id == 104|| $job_id == 126|| $job_id == 147|| $job_id == 168 AND $is_proposed == 1)
	 {
	 ...
	 if($job_class_id == 1 || $job_id == 999|| $job_id == 47|| $job_id == 146|| $job_id == 167|| $job_id == 129 AND $is_proposeddiv == 1)
	 {
	 ...
	 //ACKN
	  if ($job_class_id == 2 ||  $job_id == 999|| $job_id == 6|| $job_id == 36|| $job_id == 48|| $job_id == 104|| $job_id == 126|| $job_id == 147|| $job_id == 168 || $job_id == 146 )
	...
	if ( $job_class_id == 3 || $job_id == 999|| $job_id == 141|| $job_id == 68 || $job_id == 147|| $job_id == 138|| $job_id == 132|| $job_id == 132|| $job_id == 151 || $job_id == 37|| $job_id == 169|| $job_id == 107|| $job_id == 111 || $job_id == 74|| $job_id == 85|| $job_id == 49|| $job_id == 60|| $job_id == 91|| $job_id == 183|| $job_id == 25|| $job_id == 211|| $job_id == 220 )
	{
...
/* 				if($is_proposed == 1)
			   ...
			   if ($status_cancel == 'T') 
				...
				{
					$stat_can = 'Altered to next fiscal year';
				}
			...
			$ret .= "<tr><td id='tdclass_${id}' style='margin: 0px; padding:0px;' colspan=11 >"
					...
					. "<td id='td_status_cancel_${id}' $editlink style='text-align: center;'>".$stat_can."</td>"
					. "</tr></tbody></table>"
                  . "</td></tr>";
 ...
 var wdv = null;
   ...
   function main() {
      ...
      switch ($this->catch) {
         case $this->blockID:
            $ret = $this->antrainsscancelalter($self_employee_id);
            break;
         default:
            $ret = $this->antrainsscancelalter($self_employee_id);
            break;
