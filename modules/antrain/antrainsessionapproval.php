...
if ( !defined('ANTRAIN_ANTRAINSESSIONAPPROVAL_DEFINED') ) {
   define('ANTRAIN_ANTRAINSESSIONAPPROVAL_DEFINED', TRUE);

include_once(XOCP_DOC_ROOT."/modules/antrain/modconsts.php");

class _antrain_ANTRAINSessionApproval extends XocpBlock {
   var $catchvar = _HRIS_CATCH_VAR;
   var $blockID = _ANTRAIN_ANTRAINSESSIONAPPROVAL_BLOCK;
   var $width = "100%";
   var $language;
