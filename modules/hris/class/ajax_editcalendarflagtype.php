<?php
//--------------------------------------------------------------------//
// Filename : modules/hris/class/ajax_editcalendarflagtype.php                //
...
if ( !defined('HRIS_CALENDARFLAGTYPEAJAX_DEFINED') ) {
   define('HRIS_CALENDARFLAGTYPEAJAX_DEFINED', TRUE);

require_once(XOCP_DOC_ROOT."/class/xocpajaxlistener.php");

class _hris_class_EditCalendarFlagTypeAjax extends AjaxListener {
   
   function _hris_class_EditCalendarFlagTypeAjax($act_name) {
      $this->_act_name = $act_name;
      $this->_include_file = XOCP_DOC_ROOT."/modules/hris/class/ajax_editcalendarflagtype.php";
      $this->init();
      parent::init();
   }
   
   function init() {
      $this->registerAction($this->_act_name,"app_Delete","app_editFlag","app_saveFlag");
   }
...
} /// HRIS_CALENDARFLAGTYPEAJAX_DEFINED
?>