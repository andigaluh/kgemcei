...
include_once(XOCP_DOC_ROOT."/modules/hris/class/orgdiagram.php");

class _hris_OrganizationChart extends XocpBlock {
   var $catchvar = _HRIS_CATCH_VAR;
   var $blockID = _HRIS_ORGCHART_BLOCK;
   var $width = "100%";
   var $language;
   var $display_title = TRUE;
   var $title = "Organization Structure";
   var $display_comment = TRUE;
   var $data;
   
   function _hris_OrganizationChart($catch=NULL) { /* fungsi konstruktor wajib punya parameter $catch
   ...
   function diagram($arr=NULL) {
      ...
      return $js."<br/>Dibawah ini adalah struktur organisasi tingkat perusahaan.
      Untuk melihat detil organisasi silakan klik di kotak yang diinginkan.
      <hr noshade='1' size='1'/>
      <span style='font-style:italic;'>This below is corporate organization level structure. To see more detail organization please click the desired box.</span>
