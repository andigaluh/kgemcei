...
";
   ...
   function _idp_view_request($employee_id,$job_id,$back_button=TRUE,$new_button=TRUE) {
      ...
      $ret = "<div style='max-width:980px;'><div>"
           ...
           . "<table style='width:100%;' class='xxlist'><thead><tr>"
               . "<td style='text-align:center;background-color:#eee;font-weight:bold;border-bottom:0px;'>List of IDP"
               . " <input type='button' value='New IDP' style='".($new_button==TRUE?"":"display:none;")."float:right;' onclick='new_idp();'/></td>"
           . "</tr></thead><tbody>"
