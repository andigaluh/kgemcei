...
if ( !defined('HRIS_IDPSUPERIORAPPROVAL_DEFINED') ) {
   define('HRIS_IDPSUPERIORAPPROVAL_DEFINED', TRUE);
...
class _hris_IDPSuperiorApprove extends XocpBlock {
   var $catchvar = _HRIS_CATCH_VAR;
   var $blockID = _HRIS_IDPSUPERIORAPPROVAL_BLOCK;
   var $width = "100%";
   var $language;
   var $display_title = TRUE;
   var $title = _HRIS_IDPSUPERIORAPPROVAL_BLOCK_TITLE;
   var $display_comment = TRUE;
   var $data;
   
   function _hris_IDPSuperiorApprove($catch=NULL) { /* fungsi konstruktor wajib punya parameter $catch
   ...
   function requestList() {
      ...
      if($db->getRowsNum($result)>0) {
         while(list($request_id,$employee_id,$approve_superior_id,$approve_superior_dttm,$approve_hris_id,$approve_hris_dttm,$cost_estimate,$requested_dttm,$status_cd)=$db->fetchRow($result)) {
            ...
            if($status_cd!="approval1") continue;
            ...
            if($first_assessor_job_id!=$self_job_id) continue;
...
} // HRIS_IDPSUPERIORAPPROVAL_DEFINED
?>
