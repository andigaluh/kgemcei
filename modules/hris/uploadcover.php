...
if(isset($_FILES["zfile"])) {
   $ftmp = $_FILES["zfile"]["tmp_name"];
   $image_nm = $_FILES["zfile"]["name"];
   ...
   $picture_nm = strtoupper("picture_cover_${person_id}${ext}");
   ...
   if($ext!=""&&$ftmp!=""&&$fname!=""&&move_uploaded_file($ftmp, XOCP_DOC_ROOT.$fname)) {
      ...
      function loadFile() {
         ...
         par.load_thumbnail_cover('$person_id','".uniqid()."');
      }
      ";
   }
}
...
<script type='text/javascript' language='javascript'><!--
      ...
      function do_upload_cover(frm_id,d,e) {
...
<form method="post" enctype="multipart/form-data" id='jform' name='jform' action=''>

<input type='hidden' name='MAX_FILE_SIZE' value='100000000'/>
<input type='file' id='zfile' name='zfile'/>
<br/><br/>
<input type='button' value='Upload' id='houpload' name='houpload' onclick='do_upload_cover("jform",this,event);'/>
