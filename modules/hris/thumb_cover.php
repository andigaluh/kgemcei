...
class img {
	...
	function img($person_id){
      ...
      //// detect image:
      if(file_exists(XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.JPG")) {
         $mime_type = "image/jpeg";
         $file = XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.JPG";
      } else if(file_exists(XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.GIF")) {
         $mime_type = "image/gif";
         $file = XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.GIF";
      } else if(file_exists(XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.PNG")) {
         $mime_type = "image/png";
         $file = XOCP_DOC_ROOT."/modules/hris/data/person/PICTURE_COVER_${person_id}.PNG";
      } else {
         $mime_type = "image/png";
   ...
   function resize($width = 150, $height = 60, $aspectradio = true){
